...
import histologyPracticalsFullData from "@/data/lessons/histology-practicals-full.json";
import { lessonMatchesExam, type CoreLesson, type LessonCollection, type LessonExamId } from "@/src/lib/lessons/types";

const collections = [embryologyData, histologyData, july29Data, curriculumGapData, july29ComprehensiveData, histologyPracticalsData, histologyPracticalsFullData] as unknown as LessonCollection[];

export const allLessons: CoreLesson[] = collections.flatMap((collection) => collection.lessons);
export const histologyPracticalLessons = [...histologyPracticalsData.lessons, ...histologyPracticalsFullData.lessons] as CoreLesson[];

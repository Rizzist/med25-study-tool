...
- `scripts/generate-histology-identification-15.mjs` — reproducible 60-question written-identification bank with paired wide/close fields for the confirmed Aug 22 slides
